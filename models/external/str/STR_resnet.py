...
class ResNet(nn.Module):
    def __init__(self, builder, block, layers, num_classes=1000):
        ...
        if False: # args.first_layer_dense:
        ...
        if False: #args.last_layer_dense:
...
def ResNet18(pretrained=False, num_classes=1000):
    # TODO: pretrained
    return ResNet(builder.get_builder(), BasicBlock, [2, 2, 2, 2], num_classes)


def ResNet50(pretrained=False, num_classes=1000):
    # TODO: pretrained
    return ResNet(builder.get_builder(), Bottleneck, [3, 4, 6, 3], num_classes)
