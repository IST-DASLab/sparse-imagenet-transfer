...
import importlib
from . import conv_type
importlib.reload(conv_type)
from . import bn_type
importlib.reload(bn_type)
...
class Builder(object):
    ...
    def _init_conv(self, conv):
        if False:#args.init == "signed_constant":
        ...
        elif False: #args.init == "unsigned_constant":
        ...
        elif True: #args.init == "kaiming_normal":
        ...
        elif False: #args.init == "standard":
            nn.init.kaiming_uniform_(conv.weight, a=math.sqrt(5))
        else:
            raise ValueError(f"is not an initialization option!")


def get_builder():


    #conv_layer = getattr(utils.conv_type, "STRConv")
    #bn_layer = getattr(utils.bn_type, "LearnedBatchNorm")
    conv_layer = conv_type.STRConv
    bn_layer = bn_type.LearnedBatchNorm
