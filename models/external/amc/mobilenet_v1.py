...
"""This is the mobilenet-v1 version used by AMC.
Its top-1 on ImageNet is supposed to be 71.17%.
...
class MobileNet(nn.Module):
    def __init__(self, num_classes=1000,  profile='normal'):
...
# def mobilenet_v1_dropout_025(pretrained=False):
#     return MobileNet(channel_multiplier=0.25)


# def mobilenet_v1_dropout_050(pretrained=False):
#     return MobileNet(channel_multiplier=0.5)


# def mobilenet_v1_dropout_075(pretrained=False):
#     return MobileNet(channel_multiplier=0.75)


def mobilenet_v1_dropout(pretrained=False, num_classes=1000):
