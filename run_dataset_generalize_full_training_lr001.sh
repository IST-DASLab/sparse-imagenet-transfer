...
python main.py \
	...
	--transfer_config_path="configs/imagenet_transfer_fullnetwork_transfer.yaml" \
	--exp_name="${checkpoints[i]}-${transfer_dset}-small-lr" \
	--use_wandb \
	--wandb_name="${checkpoints[i]}-${transfer_dset}-small-lr" \
